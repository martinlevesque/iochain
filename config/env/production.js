...
module.exports = {
  ...
  **************************************************************************/
  /*
  ssl: {
    ca: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/www.iochain.co/www.iochain.co.ca-bundle')),
    key: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/my-ssl.key')),
    cert: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/www.iochain.co/www.iochain.co.crt'))
  },
  */
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'http://www.iochain.co/',
    internalEmailAddress: 'info@iochain.co',
